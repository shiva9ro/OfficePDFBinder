...
```text
OfficePDFBinder_Setup_1.3.0.exe
OfficePDFBinder_Portable_1.3.0.zip
```
...
- v1.0.0 をインストール済みの場合は、先に v1.0.0 をアンインストールしてから v1.3.0 をインストールしてください。
